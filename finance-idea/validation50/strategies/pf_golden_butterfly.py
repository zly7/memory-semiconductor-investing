"""46 — Golden Butterfly: 20% each SPY / IJS / SHY / TLT / GLDM."""
import pandas as pd
...
META = StrategyMeta(
    id="pf_golden_butterfly",
    name_cn="Golden Butterfly",
    family="allocation",
    lit_verdict="robust",
)
